...
const Login = () => {
  return (
    <>
      ...
      <div className="col-md-3 bg-light p-3 rounded-3 min-w-70">
        <form className="p-3 row justify-content-center" >
          ...
          <a className="lh-base fs-6 fw-light text-secondary text-decoration-none">forgot your password ?</a>
          </fieldset>
          <button className="btn btn-danger mt-3 mb-3 rounded-pill" type="submit">log in</button>
        </form>
